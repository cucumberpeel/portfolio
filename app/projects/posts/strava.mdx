---
title: 'What's Amory Doing: Strava API Integration'
publishedAt: '2026-06-09'
summary: 'I utilize the Strava API to create a widget for my website (yes, this one).'
---

I've seen some people create little Spotify API widgets that display their recent listening activity. I figured I could do something similar, but with Strava.

## Access and Refresh Tokens



At some point, I logged into Strava and realized they already offer two widgets.

[screenshot]

However, they aren't that visually appealing (sorry) and only highlight run activities.
